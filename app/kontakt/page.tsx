...
const MessengerIcon = ({ size = 22, className = "" }: { size?: number, className?: string }) => (
  ...
  >
    ...
    <path d="m15.09 14.53 3.32-5.31c.25-.41-.24-.92-.68-.66l-4.13 3-2.61-2.99a.8.8 0 0 0-1.11 0l-3.32 5.3c-.26.42.23.93.68.67l4.13-3 2.61 2.99c.31.3.8.3 1.11 0z" fill="currentColor" stroke="none" />
  </svg>
);
