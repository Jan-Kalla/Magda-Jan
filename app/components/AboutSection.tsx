...
export default function AboutSection() {
  ...
  // Jawne typowanie Variants pomaga w uniknięciu błędów
  const containerVariants: Variants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: 0.02, // Szybszy efekt "pisania"
        delayChildren: 0.3,
      }
    }
  };
  ...
  const wordVariants: Variants = {
    ...
    visible: { 
      ...
      transition: {
        duration: 0.5,
        // TUTAJ POPRAWKA: 'as const' rozwiązuje problem TypeScripta
  ...
  return (
    <div className="w-full text-[#4c4a1e]">
      ...
      <motion.div 
        ...
        className="max-w-3xl mx-auto px-6 pt-16 md:pt-24 mb-96 text-center flex flex-col items-center"
      >
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-6 lg:gap-12 mb-20 md:mb-32">
        ...
        <div className="flex-1 flex flex-col items-start text-left pt-2">  
          ...
          <motion.h2 
            ...
            className="font-serif font-light text-2xl md:text-3xl lg:text-4xl xl:text-5xl uppercase tracking-[0.1em] lg:tracking-[0.15em] mb-12 md:mb-20 whitespace-nowrap"
          >
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="font-serif font-normal text-lg md:text-xl leading-relaxed max-w-lg text-justify hyphens-auto flex flex-wrap"
          >
