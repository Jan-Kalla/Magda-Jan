...
export default function ChurchSection() {
  ...
  return (
    <section className="relative z-10 px-8 pt-[300px] pb-20 flex flex-col lg:flex-row items-center lg:items-stretch gap-12 lg:gap-16 text-[#F6f4e5]">
      ...
      {/* PRAWA KOLUMNA - TEKST */}
      <div className="w-full lg:flex-[1] flex flex-col text-left relative z-10 pt-2">
        
        {/* NAGŁÓWEK - Zostaje na górze wyrównany do zdjęcia */}
        <motion.div
        ...
        >
          ...
          <AnimatedText 
              ...
              className="font-serif italic text-lg md:text-xl opacity-80 text-[#F6f4e5]" 
              delay={0.3} 
              mode="line" 
          />
        </motion.div>

        {/* RESZTA TREŚCI - Obniżona za pomocą marginesu górnego */}
        {/* ZMIANA: Dodano mt-18 md:mt-26, aby obniżyć te elementy względem nagłówka */}
        <div className="mt-18 md:mt-26">
          <motion.p
            ...
            className="font-serif text-2xl md:text-3xl mb-4 leading-snug text-[#F6f4e5]"
          >
          ...
          <AnimatedText 
              ...
              className="font-serif text-xl md:text-2xl opacity-90 text-[#F6f4e5]"
              delay={0.6} 
              mode="line" 
          />
          ...
          <motion.div 
            ...
            className="flex flex-col items-start gap-8 mt-16 lg:mt-24 mb-12"
          >
          ...
          <AnimatedText
            ...
            className="font-serif text-2xl opacity-80 hover:opacity-100 cursor-pointer transition-opacity italic text-[#F6f4e5]"
            delay={1.0}
            mode="line"
          />
        </div>
