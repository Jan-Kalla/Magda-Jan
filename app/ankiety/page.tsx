  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FAD6C8] to-[#4E0113] pt-20">
      ...
      >
        ...
        <MainCourseSelector dishes={mainCourses} mainCourse={mainCourse} setMainCourse={setMainCourse} />
        ...
        {message && <p className="mt-8 text-center text-[#4E0113] font-medium text-lg">{message}</p>}
      </form>
