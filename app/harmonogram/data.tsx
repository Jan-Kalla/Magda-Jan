...
export const scheduleData: TimelineEvent[] = [
  ...
  // --- AKT I ---
  {
    ...
    description: "Pierwsza punkt specjalny wydarzenia.",
    details: "Chcemy tutaj docenić zwłaszcza obecność tych, z którymi nie mamy okazji spotykać się zbyt często.",
  ...
  // --- AKT II ---
  {
    ...
    description: "Podróż w czasie do lat szkolnych i studenckich aż po teraźniejszość.",
    details: "Chcemy tutaj docenić zwłaszcza obecność tych, którzy stanęli na naszej drodze w trakcie naszego życia.",
  ...
  // --- AKT III ---
  {
    ...
    details: "Chcemy tutaj docenić zwłaszcza obecność tych, z którymi jesteśmy najdłużej i najczęściej.",
...

  {
    ...
    time: "22:00",
    title: "Kolacja",
    description: "Przygotujcie się na prawdziwy festiwal!",
...

  {
    ...
    time: "1:00",
    title: "Druga Kolacja",
    description: "To właśnie tutaj będzie barszczyk",
    icon: <PartyPopper className="w-5 h-5 text-white" />,
    type: "event",
  },
